...
export async function GET() {
  try {
    ...
    const teams = await sql`SELECT id, name, position FROM teams ORDER BY position ASC, id ASC`;
    const projects = await sql`SELECT id, team_id, name, notes, position FROM projects ORDER BY position ASC, id ASC`;
