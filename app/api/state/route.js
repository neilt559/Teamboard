...
export async function GET() {
  try {
    ...
    const projects = await sql`SELECT id, name, notes FROM projects ORDER BY position ASC, id ASC`;
    const tasks = await sql`SELECT id, project_id, title, assignee_id, due_date, status, archived
